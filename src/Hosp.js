    ...
    <div className='hosp'>
      <div id='share'>
        ...
        <div className='charge'>
          <h3 className='design'>
            {props.type === 'government' ? t('MALE') : t('FEMALE')}
          </h3>
        ...
        <div className='oxygen'>
          <div>
            <h3 className='format'>{t('Teens')}</h3>
          ...
          <div className='shift'>
            <h3 className='format'>{t('Adults')}</h3>
            <h3 className='format1'>
          ...
          <div>
            <h3 className='format'>{t('Middle Ages')}</h3>
            <h3 className='format1'>
          ...
          <div>
            <h3 className='format'>{t('Senior Adult')}</h3>
            <h3 className='format1'>
